...
const HomepageSearchForm = (props) =>
    <div>
        <h2>Find the true cost of a flight - Baggage Included</h2>
        <form>
            <div className="row">
            ...
            <div className="row">
                ...
                <div className="col-md-2">
                    <div className="form-group form-group-lg">
                        ...
                        <BaggageInput onChange={(value) => props.onSetField('bagsCount', value)} value={props.bagsCount} />
                    </div>
                </div>
                <div className="col-md-2">
                    <div className="form-group form-group-lg">
                        <label>Carryon Bags</label>
                        <CarryonInput onChange={(value) => props.onSetField('carryon', value)} value={props.carryon} />
                    </div>
                </div>
            </div>
            {props.errorMessage ?
